...
- [x] 03-ai-assistant 모듈 완성 ✅
  - [x] README.md (프롬프트 엔지니어링, AI 활용 전략)
  - [x] starter/ 폴더 (프롬프트 연습, TODO 앱 템플릿)
  - [x] solution/ 폴더 (기본/확장 버전, 테스트)
  - [x] resources/ 폴더 (4개 템플릿 문서)
...
### Phase 3: Level 2-3 구축 (4-6주) 🚧 진행 중
**Level 2 시작**:
- [x] Level 2 폴더 구조 생성
- [x] Level 2 README.md 작성
- [x] 01-red-green-refactor 모듈 (핵심 완성)
  - [x] README.md (TDD 심화, 학습 목표)
  - [x] GUIDE.md (완전한 Phase별 가이드, 5개 Phase)
  - [x] starter/ 폴더 (템플릿, 4개 파일)
  - [x] solution/ 폴더 (완성 코드, 60개 테스트, 100% 커버리지)
  - [ ] checkpoints/ 폴더
  - [ ] resources/ 폴더
- [ ] 02-single-agent 모듈
- [ ] 03-prompt-engineering 모듈
- [ ] Level 2 project/ (쿠폰 시스템)
