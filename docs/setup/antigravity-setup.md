...
<!-- 설명: 좌측 사이드바에서 Agent Manager 위치 -->

2. **'+ New Agent'** 버튼 클릭

<!-- 📸 TODO: 스크린샷 추가 - new-agent-button.png -->
<!-- 설명: New Agent 버튼 위치 -->
...
```yaml
Name: MyFirstAgent
Model: Claude Sonnet 4.5 (추천) 또는 Gemini 3 Pro
Role: General Assistant
System Prompt: |
  너는 친절한 프로그래밍 선생님이야.
  사용자가 Python 코드를 배우는 것을 도와줘.
  항상 명확하고 이해하기 쉽게 설명해줘.
```

<!-- 📸 TODO: 스크린샷 추가 - agent-creation-form.png -->
<!-- 설명: 에이전트 생성 폼 전체 화면 -->
...
- 생성된 에이전트 옆의 토글 스위치를 **'ON'**으로 설정
- 기본 에이전트로 설정

<!-- 📸 TODO: 스크린샷 추가 - agent-activated.png -->
<!-- 설명: 에이전트가 활성화된 상태 -->
...
<!-- 📸 TODO: 스크린샷 추가 - inbox-new-conversation.png -->
...
<!-- 📸 TODO: 스크린샷 추가 - first-conversation.png -->
<!-- 설명: AI와의 첫 대화 예시 -->
